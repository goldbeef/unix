...
# 16 "all_def.h" 2
# 1 "/usr/include/i386-linux-gnu/sys/signalfd.h" 1 3 4
# 23 "/usr/include/i386-linux-gnu/sys/signalfd.h" 3 4
...
# 24 "/usr/include/i386-linux-gnu/sys/signalfd.h" 2 3 4


# 1 "/usr/include/i386-linux-gnu/bits/signalfd.h" 1 3 4
# 23 "/usr/include/i386-linux-gnu/bits/signalfd.h" 3 4
enum
  {
...
# 27 "/usr/include/i386-linux-gnu/sys/signalfd.h" 2 3 4
...
# 1 "check.h" 1
# 19 "all_def.h" 2
# 1 "signal_function.c" 1
# 12 "signal_function.c"
...
int printSigMask(FILE* of, const char* msg)
{
    ...
    if (sigprocmask(0, ((void *)0), &curMask) < 0)
    {
...
int main(int argc, char* argv[])
{
    ...
    {
        do { if (-1 == -1) { printf("(%s:%d) ret[%d] ""Usage: %s sig1 ...\n""\n", "signalfd_sigval.c", 20, -1, argv[0]); return -1; } } while(0);;
    }
    ...
    int ret = sigprocmask(2, &mask, ((void *)0));
    do { if (ret == -1) { printf("(%s:%d) ret[%d] ""sigprocmask error""\n", "signalfd_sigval.c", 30, ret); return ret; } } while(0);;

    sfd = signalfd(-1, &mask, 0);
    do { if (sfd == -1) { printf("(%s:%d) ret[%d] ""signalfd error""\n", "signalfd_sigval.c", 33, sfd); return sfd; } } while(0);;
    ...
    while (1)
    {
        ...
        {
            do { if (-1 == -1) { printf("(%s:%d) ret[%d] ""read size error""\n", "signalfd_sigval.c", 40, -1); return -1; } } while(0);;
        }
